...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String url = "http://bin2580.16mb.com/library_services/soa_login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button lgin = (Button) findViewById(R.id.button);
        ...
        protected Void doInBackground(Void... params) {
            ...
            for (int i = 0; i < al.length ; i++) {
                if (user.equals(us[i]) && pass.equals(pw[i])) {
                    flag = true;SessionManager sm= new SessionManager(getApplicationContext());
                    sm.setUserID(user);
                    startActivity(j);
                }
            }
